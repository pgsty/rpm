...
Summary:	PostgreSQL extension that provides high-accuracy timing of SQL expressions.
License:	PostgreSQL
URL:		https://github.com/joelonsql/pg-timeit
Source0:	pg-timeit-%{version}.tar.gz
