%global pname tinyint
%global sname pg_tinyint
...
Summary:	A tiny int implementation as a data type of PostgreSQL
License:	PostgreSQL
URL:		https://github.com/umitanuki/tinyint-postgresql
Source0:	tinyint-postgresql-v_0_1_1.tar.gz
...
%prep
%setup -q -n tinyint-postgresql-v_0_1_1
...
%changelog
* Sat Aug 10 2024 Vonng <rh@vonng.com> - 0.1.1
