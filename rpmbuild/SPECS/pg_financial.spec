%global pname financial
%global sname pg_financial
...
%description
This is a PostgreSQL extension for financial calculations. Functions provided:
...
%{pginstdir}/doc/extension/financial.md
%if %llvm
%files llvmjit
