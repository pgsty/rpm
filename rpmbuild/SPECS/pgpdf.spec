...
Summary:	pdf type for Postgres
License:	GPL-2.0
URL:		https://github.com/Florents-Tselai/pgpdf
Source0:	pgpdf-%{version}.tar.gz

BuildRequires:	postgresql%{pgmajorversion}-devel pgdg-srpm-macros >= 1.0.27 poppler-glib-devel >= 20
