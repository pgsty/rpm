...
Patch0:		pg_uuid_v8-1.1.0.patch
#           normalized from https://api.pgxn.org/dist/pg_uuid_v8/1.1.0/pg_uuid_v8-1.1.0.zip
...
# disable LLVM for this package until a JIT payload is intentionally
# packaged and tested.
...
%changelog
* Wed Aug 12 2026 Vonng <rh@vonng.com> - 1.1.0-1PIGSTY
- Update to upstream PGXN 1.1.0
- Keep the public-schema operator fix for PostgreSQL 17 and 18
- Package the 1.0 to 1.1 upgrade script and upstream timestamp fix
